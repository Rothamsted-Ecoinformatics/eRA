...
<div id="idExpt">
	<div id="greenTitle" class="d-flex  mb-3 py-3 p3-3 bg-primary text-white mt-0 ">
			...
			<div class="modal-footer">
				<form method="POST" class="was-validated" >
					...
					<div class="form-group">
							...
							<label class="form-check-label" for="understandCheck" > <b>e-RA collects information to understand how the data is used and for justification of continued funding</b></label>
							
						</div>
						<div class="form-group">
							<label for="InputName"><h5>Full Name</h5></label> 
						...
						<div class="form-group">
						<label for="InputInstitute"><h5>Name and Type of Organisation (Academic, Industry, Farm, School or Other)</h5></label> 
							<input type="text" class="form-control" id="InputInstitute" name="InputInstitute"
								placeholder="Organisation's name and type" value="<?php echo $institution; ?>"
						...
						<div class="form-group">
						<label for="inputCountry"><h5>Country</h5></label>
						...
						<div class="form-group">
						<label for="information"><h5>How will the data be used?</h5></label>
