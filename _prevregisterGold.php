...
<div class="form-group my-3">
				...
				<div class="datasetsList " id="dsrbk1">
					...
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKYIELD_F" <?php echo $vRGDSsel['BKYIELD_F'];?>> <label class="form-check-label" for="RGDS[]">BKYIELD_F
							(Broadbalk wheat yields 1926-1953)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKYIELD_F85" <?php echo $vRGDSsel['BKYIELD_F85'];?>> <label class="form-check-label" for="RGDS[]">BKYIELD_F85
							(Broadbalk wheat yields 1954-1967)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKYIELD_R85" <?php echo $vRGDSsel['BKYIELD_R85'];?>> <label class="form-check-label" for="RGDS[]">BKYIELD_R85
							(Broadbalk wheat yields 1968-2017)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKBEANS" <?php echo $vRGDSsel['BKBEANS'];?>> <label class="form-check-label" for="RGDS[]">BKBEANS
							(Broadbalk beans yields 1968-1978)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKFMAIZE" <?php echo $vRGDSsel['BKFMAIZE'];?>> <label class="form-check-label" for="RGDS[]">BKFMAIZE
							(Broadbalk maize yields 1997-2017)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKOATS" <?php echo $vRGDSsel['BKOATS'];?>> <label class="form-check-label" for="RGDS[]">BKOATS
							(Broadbalk oats yields 1996-2017)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKPOTATO" <?php echo $vRGDSsel['BKPOTATO'];?>> <label class="form-check-label" for="RGDS[]">BKPOTATO
							(Broadbalk potato yields 1968-1996)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKWHNUTRI" <?php echo $vRGDSsel['BKWHNUTRI'];?>> <label class="form-check-label" for="RGDS[]">BKWHNUTRI
							(Broadbalk wheat crop nutrient data 1968-2013)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKOATNUTRI" <?php echo $vRGDSsel['BKOATNUTRI'];?>> <label class="form-check-label" for="RGDS[]">BKOATNUTRI
							(Broadbalk oat crop nutrient data 1996-2013)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKBEANNUTRI" <?php echo $vRGDSsel['BKBEANNUTRI'];?>> <label class="form-check-label" for="RGDS[]">BKBEANNUTRI
							(Broadbalk beans crop nutrient data 1968-1978)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKMAIZNUTRI" <?php echo $vRGDSsel['BKMAIZNUTRI'];?>> <label class="form-check-label" for="RGDS[]">BKMAIZNUTRI
							(Broadbalk maize crop nutrient data 1997-2013)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKPOTSNUTRI" <?php echo $vRGDSsel['BKPOTSNUTRI'];?>> <label class="form-check-label" for="RGDS[]">BKPOTSNUTRI
							(Broadbalk potato crop nutrient data 1968-96)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKWEEDS_FAL" <?php echo $vRGDSsel['BKWEEDS_FAL'];?>> <label class="form-check-label" for="RGDS[]">BKWEEDS_FAL
							(Broadbalk weed surveys 1933-1967)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKWEEDS_ROT" <?php echo $vRGDSsel['BKWEEDS_ROT'];?>> <label class="form-check-label" for="RGDS[]">BKWEEDS_ROT
							(Broadbalk weed surveys 1968-1979)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKWEEDS_SUM" <?php echo $vRGDSsel[''];?>> <label class="form-check-label" for="RGDS[]">
					...
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="BKDISEASE" <?php echo $vRGDSsel['BKDISEASE'];?>> <label class="form-check-label" for="RGDS[]">BKDISEASE
				...
				<div class="datasetsList" id="dsrpg5">
					...
					<div class="form-check  ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="PARKYIELD" <?php echo $vRGDSsel['PARKYIELD'];?>> <label class="form-check-label" for="RGDS[]">PARKYIELD
							(Park Grass yields 1856-1959)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="PGHAYEQUIV" <?php echo $vRGDSsel['PGHAYEQUIV'];?>> <label class="form-check-label" for="RGDS[]">PGHAYEQUIV
							(Park Grass yields 1960-2017)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="PARKCOMP" <?php echo $vRGDSsel['PARKCOMP'];?>> <label class="form-check-label" for="RGDS[]">PARKCOMP
					...
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="PARKCOMPIC" <?php echo $vRGDSsel['PARKCOMPIC'];?>> <label class="form-check-label" for="RGDS[]">PARKCOMPIC
							(Park Grass botanical surveys carried out by Imperial College
							1991-2000)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="PARKINSECTS" <?php echo $vRGDSsel['PARKINSECTS'];?>> <label class="form-check-label" for="RGDS[]">PARKINSECTS
				...
				<div class="datasetsList" id="dsrhb2">
					...
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="HOOSYIELD1" <?php echo $vRGDSsel['HOOSYIELD1'];?>> <label class="form-check-label" for="RGDS[]">HOOSYIELD1
							(Hoosfield barley yields 1954-1957)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="HOOSYIELD2" <?php echo $vRGDSsel['HOOSYIELD2'];?>> <label class="form-check-label" for="RGDS[]">HOOSYIELD2
							(Hoosfield barley yields 1958-1966 (fallow 1967))</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="HOOSYIELD3" <?php echo $vRGDSsel['HOOSYIELD3'];?>> <label class="form-check-label" for="RGDS[]">HOOSYIELD3
							(Hoosfield barley yields 1968-1993)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="HOOSYIELD4" <?php echo $vRGDSsel['HOOSYIELD4'];?>> <label class="form-check-label" for="RGDS[]">HOOSYIELD4
							(Hoosfield barley yields 1994-2002)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="HOOSYIELD5" <?php echo $vRGDSsel['HOOSYIELD5'];?>> <label class="form-check-label" for="RGDS[]">HOOSYIELD5
							(Hoosfield barley yields 2003-2016)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="HFBNUTRI" <?php echo $vRGDSsel['HFBNUTRI'];?>> <label class="form-check-label" for="RGDS[]">HFBNUTRI
							(Hoosfield barley crop nutrient data, 1964 and 1966)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="HFNUTRIMAIN" <?php echo $vRGDSsel['HFNUTRIMAIN'];?>> <label class="form-check-label" for="RGDS[]">HFNUTRIMAIN
				...
				<div class="datasetsList" id="dsrfw3">
					...
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="WHEATFAL" <?php echo $vRGDSsel[''];?>> <label class="form-check-label" for="RGDS[]">WHEATFAL
							(Yields from the alternate wheat/fallow experiment 1856-1956)</label>
					</div>
					<div class="form-check ml-5">
						<input type="checkbox" class="form-check-input" name="RGDS[]"
							value="FALWHEAT" <?php echo $vRGDSsel[''];?>> <label class="form-check-label" for="RGDS[]">FALWHEAT
