...
<LI class="nicelist"><A href="<?php echo $request; ?>#DDA"><B>DDA</B></A>:	Day Degrees Above a base temperature (TLIM)	</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#DDB"><B>DDB</B></A>:	Day Degrees Below a base TLIM	</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#ACDDA"><B>ACCDDA</B></A>:	Accumulated Day Degrees Above TLIM	</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#ACDDB"><B>ACCDDB</B></A>:	Accumulated Day Degrees Below TLIM	</li>
...
<LI class="nicelist"><A href="<?php echo $request; ?>#WINDRUN"><B>WINDRUN</A>:</B>	Run of wind in 24h, 0900GMT to 0900GMT </li>
<LI class="nicelist"><A href="<?php echo $request; ?>#DEWP"><B>DEWP</A>:</B>	Dew point (ºC)</li>	
<LI class="nicelist"><A href="<?php echo $request; ?>#RAD"><B>RAD</A>:</B>	Radiation </li>
</ul>

<p>Other definitions:</p>
<ul>

<LI class="nicelist"><A href="<?php echo $request; ?>#AVTEMP"><B>AVTEMP</A>:</B>	Average temperature (ºC)	</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#TRANGE"><B>TRANGE</A>:</B>	Temperature range (ºC)	</li>
<LI class="nicelist"><B>TMIN:</B>	Daily minimum temperature (ºC)	</li>
<LI class="nicelist"><B>TMAX:</B>	Daily maximum temperature (ºC)	</li>
<LI class="nicelist"><A href="<?php echo $request; ?>#TLIM"><B>TLIM</A>:</B>	The (arbitrary) limiting or base temperature (set by user)	</li>
<LI class="nicelist"><B>WETB:</B>	Wet bulb temperature (ºC)	</li>
<LI class="nicelist"><B>DRYB:</B>	Dry bulb temperature (ºC)	</li>
...
<p>SVAP=6.107799961+DRYB*(4.436518521*10<sup>-1</sup>+DRYB*(1.428945805*10<sup>-2</sup>+DRYB*(2.650648471*10<sup>-4</sup>+DRYB*(3.031240396*10<sup>-6</sup>+DRYB*(2.034080948*10<sup>-8</sup>+6.136820929*10<sup>-11</sup>*T))))) </p>
...
<p>stn_latitude is the latitude of the station in question: Rothamsted = 51.81ºN
<p>Woburn =  52.017 ºN Brooms Barn = 52.267 ºN.</p>
