...
<LI><A href="<?php echo $request; ?>#SEC8">Vapour pressure</A></LI>
<LI><A href="<?php echo $request; ?>#SEC9">Barometric pressure</A></LI>
<LI><A href="<?php echo $request; ?>#SEC10">Other variables</A></LI>
<LI><A href="<?php echo $request; ?>#SEC11">References</A></LI>
</UL>
...
<p>The variable <B>RAIN </B> was originally recorded in a 5 inch (12.7cm) rain gauge built in a garden near the laboratory in 1852. The water collected was measured in a graduated cylinder until about 1880. The gauge was then moved to the meteorological enclosure. In 1948, a 5 inch (12.7cm) copper rain gauge of Meteorological Office standard was installed within a 0.3 m high, 1.5 m radius turf wall retained by brick to reduce wind eddies. Since 2004, <B>RAIN </B> has been measured by an electronic tipping bucket rain gauge of 25.4cm diameter, calibrated to tip at 0.2mm, also within the turf wall. The old 5 inch copper rain gauge is still used to measure precipitation fallen as snow when the tipping bucket rain gauge is blocked with snow or ice. 
 </p>
...
<p>Daily temperature is measured over the 24 hour period 0900 to 0900GMT; this is used for the previous day's maximum <b>(TMAX)</b> and the current day's minimum temperature<B> (TMIN)</B>. All other temperatures are recorded at 0900GMT. Until 1970 all temperatures were measured in ºF; since 1972 they have been recorded in ºC. All temperatures in e-RA are displayed as ºC. </p>
...
Thus, data from before 1955 should be treated with some caution. A Kipp and Zonen integrator was installed in 1989. In 2004 this was replaced by a Kipp and Zonen thermopile
pyranometer. </p>

<p> Data from Rothamsted are recorded as J/cm<sup>2</sup>. To convert to MJ/m<sup>2</sup> divide by 100.</p>
...
<p>Other variables were recorded onto Meteorological Office return sheets as extra columns. Evaporation, vapour pressure, dew point, relative humidity and
...
Since 2009, at Woburn, the wet bulb sensor has been replaced by a relative humidity sensor (Campbell Scientific, MP100A). </p>
