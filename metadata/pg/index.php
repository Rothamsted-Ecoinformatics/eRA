...
<p>All data available can be extracted using the <a href="<?=$det?>" target="out">e-RA Data Extraction Tool</a>. Preview sets of data are also available.
</p>


<UL>
<li class="nicelist">	Yield Data  - 1st and 2nd cuts, available 1856-2016.
<a href="<?php echo $metadata ; ?>PGHAYEQUIVexample.xlsx"> <B>Preview Data</b></a></li>
...
<li class="nicelist">	Imperial College Botanical Survey Data -1991-2000      
<a href="<?php echo $metadata ; ?>PARKCOMPICexample.xlsx"> <B>Preview Data</b></a></li>
<li class="nicelist">	Mass Effects Study Bill Kunin, Imperial College 1993-1994 (see Kunin 1998 in Key References below)   </li>
<li class="nicelist">	Insect surveys - 1977-1978. Leafhoppers (Auchenorhyncha) on 13 plots sampled five time in the summers of 1977 and 1978, 
 as described by Morris, 1992 (see Key References below)  </li>
</UL>
