...
$filedatacite= 'metadata/'.$farm.'/arrdatacite.json';
				...
				<div class="col-12 py-3">
					<ul class="nav nav-tabs nav-fill text-body ">
						<li class="nav-item active"><a class="nav-link active"
							id="timeline-tab" data-toggle="tab" href="#timeline">History</a></li>
						...
						<li class="nav-item"><a class="nav-link" id="datasets-tab"
							data-toggle="tab" href="#datasets">Experiments</a></li>
...
<?php include_once 'includes/finish.inc'; // this has the common js scripts
